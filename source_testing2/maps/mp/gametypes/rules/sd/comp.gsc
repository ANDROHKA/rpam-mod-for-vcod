/*
  ...
  rPAMext Version: v22 (kvcodPAM v211)      
  
  Changes:    
  - minor changes to addapt to CoD1
  - added set scr_hitbox_hand_fix to 1
...
GetCvars(arr)
{
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_sd_roundlength", 2.25);				// Time length of each round (min) // ClanBase_Custom
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_sd_plant_points", 0);					// kvcod v20 added 0.5 here, however we do not count these points
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_sd_defuse_points", 0);				// kvcod v20 added 0.5 here, however we do not count these points

//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_sd_sniper_shotgun_info", 0);				// Show weapon info about sniper and shotgun players
	...
	*******************************/
	...
	// Are there OT Rules?
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_overtime", 1);						// Activate overtime
...
//?	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_show_players_names_left", 0);			// z404 doesn't have this
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_show_objective_icons", 0);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_show_hitblip", 0);					// CoD1 has not hitblip
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_show_scoreboard_limit", 0);			// 1 added kvcod v20

//2	// Health Regeneration
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_health_regen", 1); 				// 0=no regen, 1=refill health after "scr_regen_delay"
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_regen_sounds", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_regen_delay", 5000); 					//Time before regen starts

	// rPAM Ambient will be enterered here
...
//r	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_ambient_smoke", 0);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_ambient_fire", 0);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_ambient_weather", 0);


//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_shellshock", 0);				// Create shell shock effect when player is hitted
...
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_remove_killtriggers", 1);				// Remove some of the kill-triggers created in 1.3 path
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "sv_fps", 20);							// Enter 30 in future
...
//	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "r_fog", 0);							
...
//v210
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_rpam_aimrun_fix", 1);				// kvcodPAM v210
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_rpam_fastshoot_msg", 0);			// kvcodPAM v210
	...
	*********/
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_boltaction_nades", 2);				// added kvcod v20
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_semiautomatic_nades", 2);				// added kvcod v20
...
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_shotgun_nades", 1);

//2	// Smoke spawn counts for each class
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_boltaction_smokes", 0);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_semiautomatic_smokes", 0);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_smg_smokes", 0);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_sniper_smokes", 0);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_mg_smokes", 0);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_shotgun_smokes", 1);

//2	// Weapon Limits by class per team
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_boltaction_limit", 99);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_sniper_limit", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_semiautomatic_limit", 99);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_smg_limit", 99);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_mg_limit", 99);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_shotgun_limit", 1);
//2	
...
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_shotgun_allow_drop", 0);
...
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_smoke_drop", 0);
...
//	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_enfieldsniper", 1);
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_panzerfaust", 0);				// added kvcod v20
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_fg42", 0);						// added kvcod v20

	// Allow/Disallow pistols
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_pistols", 1);
	
	// Allow/Disallow turrets
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_turrets", 1);
	
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_greasegun", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_m1carbine", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_m1garand", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_springfield", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_thompson", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_bar", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_sten", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_enfield", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_enfieldsniper", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_bren", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_pps42", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_nagant", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_svt40", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_nagantsniper", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_ppsh", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_mp40", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_kar98k", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_g43", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_kar98ksniper", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_mp44", 1);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_shotgun", 1);

//2	// Single Shot Kills
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_no_oneshot_pistol_kills", 0);
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_no_oneshot_ppsh_kills", 0);
//2
//2	// PPSH Balance - Limits range of PPSH to same as Tommy
//2	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_balance_ppsh_distance", 0);
