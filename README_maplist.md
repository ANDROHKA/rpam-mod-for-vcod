...
/rcon map mp_dawnville_x             
/rcon map mp_depot                 
/rcon map mp_harbor                 
/rcon map mp_hurtgen              
/rcon map mp_pavlov               
/rcon map mp_powcamp                  
/rcon map mp_railyard_x             
/rcon map mp_rocket                  
/rcon map mp_bocage                
/rcon map mp_neuville              
/rcon map mp_stalingrad              
/rcon map mp_tigertown              

**rPAM CUSTOM:**                   
/rcon map mp_germantown               
/rcon map mp_hanoi             
/rcon map mp_beauville            
/rcon map mp_pegasusday            
/rcon map mp_pegasusnight             
/rcon map mp_dufresne             
/rcon map mp_burgundy                
/rcon map mp_dawnville_gg              
/rcon map mp_toujane              

**rPAM CUSTOM WINTER:**                 
/rcon map mp_bonneville            
/rcon map mp_brecourt_winter            
/rcon map mp_carentan_winter          
/rcon map mp_container         
/rcon map mp_dawnville_winter          
/rcon map mp_dufresne_winter           
/rcon map mp_hanoi_winter          
/rcon map mp_harbor_gg            
/rcon map mp_miniharbor          
/rcon map mp_offensive          
/rcon map mp_radar           
/rcon map mp_univermag          
/rcon map mp_winterv2           
...
/rcon map mp_aim_b         
/rcon map mp_aim_r          
/rcon map mp_blaoaim_a         
/rcon map mp_blaoaim_b          
/rcon map mp_blaoaim_r            
/rcon map mp_pgaim_a           
/rcon map mp_pgaim_r          
/rcon map mp_wawa_a           
/rcon map mp_wawa_b            
...
| 03    | mp_dawnville_x                | Infinity Ward + curiousfox [03-2025]               | dm, tdm, sd, re, bel, hq         | A    | *plus further fixes v4*         |
...
| 08    | mp_powcamp                    | Infinity Ward                                      | dm, tdm, sd, re, bel, hq         | R    |                                 |
| 09    | mp_railyard_x                 | Infinity Ward + curiousfox [03-2025]               | dm, tdm, sd, re, bel, hq         | R    | *plus further fixes v4*         |
| 10    | mp_rocket                     | Infinity Ward                                      | dm, tdm, sd, re, bel, hq         | B    |                                 |
| 11    | mp_bocage                     | Infinity Ward, added by patch 1.3                  | dm, tdm, sd, re, bel, hq         | A    |                                 |
...
| 19    | mp_pegasusday                 | Infinity Ward, edited by reissue [07-2025]         | dm, tdm                          | B    | *DM & TDM overhauled*           |
| 20    | mp_pegasusnight               | Infinity Ward, edited by reissue [07-2025]         | dm, tdm                          | B    | *DM & TDM overhauled*           |
| 21    | mp_dufresne                   | [HG] Baby Seal Clubber [08-2004]                   | dm, tdm, sd, re, bel, hq         | A    | *Summer version*                |
...
| 43    | mp_brecourt_winter            | -OCG-=gLiTcH= [08-2004]                            | dm, tdm, sd, re, bel, hq         | A    |                                 |
| 44    | mp_carentan_winter            | Infinity Ward, edited by Expertiz [10-2017]        | dm, tdm, sd, re, bel             | A    |                                 |
...
| 55    | mp_aim_b                      | Yannic [05-2004]                                   | dm, tdm                          | B    |                                 |
| 56    | mp_aim_r                      | Yannic [05-2004]                                   | dm, tdm                          | R    |                                 |
| 57    | mp_blaoaim_a                  | RL.GENERAL Z [08-2004]                             | dm, tdm                          | A    |                                 |
| 58    | mp_blaoaim_b                  | RL.GENERAL Z [08-2004]                             | dm, tdm                          | B    |                                 |
| 59    | mp_blaoaim_r                  | RL.GENERAL Z [08-2004]                             | dm, tdm                          | R    |                                 |
| 60    | mp_pgaim_a                    | Unknown [04-2005]                                  | dm, tdm                          | A    |                                 |
| 61    | mp_pgaim_r                    | Unknown [04-2005]                                  | dm, tdm                          | R    |                                 |
...
|       | mp_destroyed_village          | -OCG-=gLiTcH= [05-2005]                            | dm, tdm, sd, re, bel, hq         | A    | *Has rpam edited textures*      |
|       | mp_hunt                       | [tFp] Daryl Strawberry [08-2004]                   | dm, tdm, sd,                     | A    |                                 |
...
/connect 144.76.41.252:28904; password war; echo codbase4                   
/connect 144.76.41.252:28905; password war; echo codbase5                   
/connect 144.76.41.252:28906; password war; echo codbase6                   
/connect 144.76.41.252:28907; password war; echo codbase7                   
/connect 52.59.244.174:28908; password war; echo codbase8                   
/connect 52.59.244.174:28909; password war; echo codbase9                   
/connect 144.76.41.252:28900; password war; echo codbasepublic                   
/connect 144.76.41.252:28911; password war; echo codbasesoloq1                   
/connect 144.76.41.252:28912; password war; echo codbasesoloq2                   
/connect 144.76.41.252:28913; password war; echo codbasesoloq3                   
...
| 04    | mp_depot                      | Infinity Ward                                      | dm, tdm, sd, re, bel, hq         | B    |                                 |
| 05    | mp_harbor                     | Infinity Ward                                      | dm, tdm, sd, re, bel, hq         | R    |                                 |
| 06    | mp_hurtgen_autumn             | Infinity Ward + 3FJTACTICAL [12-2004]              | dm, tdm, sd, re, bel, hq         | A    | *Historical Correct Weather*    |
| 07    | mp_pavlov                     | Infinity Ward                                      | dm, tdm, sd, re, bel, hq         | R    |                                 |
| 08 *  | mp_pegasusday                 | Infinity Ward, edited by reissue [07-2025]         | dm, tdm                          | B    | *DM & TDM added & overhauled*   |
| 09 *  | mp_pegasusnight               | Infinity Ward, edited by reissue [07-2025]         | dm, tdm                          | B    | *DM & TDM added & overhauled*   |
| 10    | mp_powcamp                    | Infinity Ward                                      | dm, tdm, sd, re, bel, hq         | R    |                                 |
| 11    | mp_railyard_x                 | Infinity Ward + curiousfox [03-2025]               | dm, tdm, sd, re, bel, hq         | R    | *plus further fixes v4*         |
| 12    | mp_rocket                     | Infinity Ward                                      | dm, tdm, sd, re, bel, hq         | B    |                                 |
|    *  | mp_bocage                     | Infinity Ward, added by patch 1.3                  | dm, tdm, sd, re, bel, hq         | A    |                                 |
| 13    | mp_neuville                   | Infinity Ward, added by patch 1.3                  | dm, tdm, sd, re, bel, hq         | A    |                                 |
| 14    | mp_stalingrad                 | Infinity Ward, added by patch 1.4                  | dm, tdm, sd, re, bel, hq         | R    |                                 |
| 15    | mp_tigertown                  | Infinity Ward, added by patch 1.5                  | dm, tdm, sd, re, bel, hq         | A    |                                 |
|       |                               |                                                    |                                  |      |                                 |
| 16    | **rPAM Custom**               |                                                    |                                  |      |                                 |
|       | `/rcon map`                   | Creator                                            | Gametypes                        | Side | rPAM Notes                      |
| 17    | mp_germantown                 | Steiner [03-2004]                                  | dm, tdm, sd,     bel             | A    |                                 |
| 18    | mp_hanoi                      | Expertiz & DigitalDials [12-2016]                  | dm, tdm, sd, re, bel             | A    | *Has commands for effects*      |
| 19    | mp_abbey                      | FORCE316 [10-2004]                                 | dm, tdm, sd, re, bel, hq         | A    | *A*                             |
| 20    | mp_amfreville                 | Steppenwolf & THE DUKE [04-2005]                   | dm, tdm, sd, re, hq              | A    | *A* *Large*                     |
|       | mp_aquitaine                  | rasta [06-2005]                                    | dm, tdm, sd                      | B    | *Beta*                          |
|       | mp_bazolles                   | Magnus Sandström & Roger Abrahamsson [07-2004]     | dm, tdm, sd, re, bel, hq         | A    |                                 |
| 21    | mp_beauville                  | IxQue [03-2004], edited by reissue [07-2025]       | dm, tdm, **sd**, bel, hq         | A    | *Full DM & S&D added!*          |
|       | mp_bellicourt                 | Magnus Sandström & Roger Abrahamsson [03-2004]     | dm, tdm, sd, re, bel, hq         | A    | *Different to night ver.*       |
| 23    | mp_bellicourt_night           | Magnus Sandström & Roger Abrahamsson [04-2004]     | dm, tdm, sd, re, bel, hq         | A    | *Fixed version used*            |
| 22    | mp_daybreak                   | Mj & Cypher [10-2005]                              | dm, tdm, sd, re, bel             | A    | *S* *Large* *v2.0 used*         |
|    *  | mp_dday7                      | [AYM] Lt Jules [06-2004]                           | dm, tdm, sd,     bel, hq         | A    | *not good to play?              |
|    *  | mp_dufresne                   | [HG] Baby Seal Clubber [08-2004]                   | dm, tdm, sd, re, bel, hq         | A    | *Summer version*                |
|    *  | mp_falaisevilla               | colpe [01-2004] & shitman [10-2009]                | dm, tdm, sd, re, bel, hq         | A    |                                 |
| 24    | mp_junobeach                  | [126th] Televinken [12-2004]                       | dm, tdm, sd, re, bel, hq         | B    | *A* *Morsers deactivated*       |
| 25    | mp_merderet_river             | Steppenwolf [04-2005]                              | dm, tdm, sd, re, bel, hq         | A    | *Edit textures & models needed* |
| 26    | mp_merville_battery           | [HOLY] Moses [07-2004]                             |     tdm, sd,          hq         | B    | *A* *DM may be added*           |
|    *  | mp_nuenen                     | [AYM] Lt Jules                                     | dm, tdm, sd,     bel, hq         | A    | *Broken windows*                |
| 27    | mp_priory                     | Filbert [08-2006]                                  | dm, tdm, sd,     bel, hq         | B    | *A*                             |
| 28    | mp_redoktober                 | Drecks, Lex & Innocent Bystander [09-2004]         | dm, tdm, sd,     bel, hq         | R    | *A* *Extra Large*               |
| 29    | mp_stanjel                    | Roger Abrahamsson [04-2006]                        | dm, tdm, sd, re, bel, hq         | R    | *A*                             |
| 30    | mp_stcomedumont               | maverick & Lt.J.Snellius [02-2005]                 | dm, tdm, sd, re, bel, hq         | A    | *A* *Large*                     |
| 31    | mp_steny                      | Spik3d [07-2007]                                   | dm, tdm, sd,     bel, hq         | A    | *A* *Similar to mp_carentan*    |
| 32    | mp_trenchville                | S.C. [07-2005]                                     | dm, tdm, sd,     bel             | A    | *A*                             |
| 33    | mp_varaville                  | IW + Slyk & Innocent Bystander [04-2004]           | dm, tdm,         bel             | A    | *A* *Extra Large* *#S&D*        |
|       | mp_westwall                   | sm0k3r [12-2003]                                   | dm, tdm, sd, re, bel, hq         | B    | *Is too dark*                   |
|       |                               |                                                    |                                  |      |                                 |
|    *  | mp_subharbor_day              | VegaObscura [03-2004]                              | dm, tdm, sd,     bel, hq         | B    | *Large*                         |
|    *  | mp_subharbor_night            | VegaObscura [03-2004]                              | dm, tdm, sd,     bel, hq         | B    | *Day allready present*          |
...
|    *  | mp_windmills                  | VegaObscura [05-2004]                              | dm, tdm, sd, re, bel             | A    | *Extra Large*                   |
|       |                               |                                                    |                                  |      |                                 |
| 34    | mp_dawnville_gg               | Infinity Ward, ported by TheGoog [12-2025]         | dm, tdm, sd,                     | A    | *v6 with full S&D models*       |
| 35    | mp_burgundy_gg                | Infinity Ward, Brutal, TheGoog [12-2025]           | dm, tdm, sd,                     | A    | *internal v33 with S&D models*  |
| 36    | mp_matmata_gg                 | Infinity Ward, Brutal, TheGoog [12-2025]           | dm, tdm, sd,                     | A    | *internal v33 with S&D models*  |
|       |                               |                                                    |                                  |      |                                 |
|       | **Blurred Remembrance**       |                                                    |                                  |      |                                 |
| 37    | mp_brest                      | VikingWiedel [09-2004]                             | dm, tdm,         bel             | A    | *Small sized map*               |
|       | mp_bridge                     | [tFp] CFH666 [09-2004]                             | dm, tdm, sd,          hq         | B    |                                 |
| 38    | mp_bridge_a                   | VikingWiedel [08-2004]                             | dm, tdm, sd,     bel             | A    | *SD ver.*                       |
| 39    | mp_bridge_beta                | VikingWiedel [06-2004]                             | dm, tdm,         bel             | A    | *Beta ver., Less rooms*         |
| 40    | mp_destroyed_village          | -OCG-=gLiTcH= [05-2005]                            | dm, tdm, sd, re, bel, hq         | A    | *Has rpam edited textures*      |
| 41    | mp_hunt                       | [tFp] Daryl Strawberry [08-2004]                   | dm, tdm, sd,                     | A    |                                 |
|       |                               |                                                    |                                  |      |                                 |
| 42    | **rPAM Custom Winter**        |                                                    |                                  |      |                                 |
|       | `/rcon map`                   | Creator                                            | Gametypes                        | Side | rPAM Notes                      |
| 43    | mp_brecourt_winter            | -OCG-=gLiTcH= [08-2004]                            | dm, tdm, sd, re, bel, hq         | A    |                                 |
| 44    | mp_carentan_winter            | Infinity Ward, edited by Expertiz [10-2017]        | dm, tdm, sd, re, bel             | A    |                                 |
| 45    | mp_dawnville_winter           | Infinity Ward, ported by Expertiz [10-2017]        | dm, tdm, sd, re, bel, hq         | A    |                                 |
| 46    | mp_container                  | openf1re [06-2004]                                 |     tdm, sd                      | R    | *DM needs to be added*          |
| 47    | mp_bonneville                 | [CF] WillyWonka [07-2004]                          | dm, tdm, sd,     bel             | A    | *Out of bounds not fixed yet*   |
|       | mp_dufresne_x                 | [HG] Baby Seal Clubber & Filbert [09-2005]         | dm, tdm, sd, re, bel, hq         | A    | *UO + further edits*            |
| 48    | mp_dufresne_winter            | [HG] Baby Seal Clubber [08-2004]                   | dm, tdm, sd, re, bel, hq         | A    | *Updated by mp_dufresne_x*      |
| 49    | mp_hanoi_winter               | Expertiz & DigitalDials [12-2016]                  | dm, tdm, sd, re, bel             | A    | *Has no effects*                |
|    *  | mp_harbor_gg                  | IW + TheGoog [06-2021]                             | dm, tdm, sd, re, bel, hq         | R    | *Spawns need to be overhauled*  |
| 50    | mp_miniharbor                 | IW + TheGoog & JtGz [05-2025]                      | dm, tdm, sd                      | R    |                                 |
|       | mp_radar                      | Fangio [12-2003]                                   | dm, tdm, sd, re, bel,            | A    |                                 |
| 51    | mp_univermag                  | Drecks & Innocent Bystander [02-2004]              | dm, tdm, sd,     bel, hq         | R    | *Large sized map*               |
| 52    | mp_winterv2                   | Oraco   [03-2006]                                  | dm, tdm, sd                      | R    | *Like mp_rocket*                |
...
|       | mp_winterambush               | Unknown [03-2006]                                  | dm, tdm, sd                      | A    | *S&D not good to play*          |
|       | mp_eisberg                    | Fangio [12-2003]                                   | dm, tdm, sd,     bel             | B    | *S&D not good to play*          |
|       | mp_offensive                  | Old-Crow & Caskou [02-2004]                        | dm, tdm, sd, re, bel, hq         | A    | *Too lany*                      |
|       | mp_remagen                    | nash [08-2004]                                     | dm, tdm,     re, bel             | A    | *Breakable Windows*             |
|       | mp_rocket_facility            | -TFO- Kilroy [02-2004]                             | dm, tdm, sd, re, bel, hq         | A    | *Openable doors*                |
|       | mp_frozen                     | SIFFER [02-2004]                                   | dm, tdm,     re, bel             | B    | *Small sized dm map*            |
|       | mp_bellicourt_night_beta      | Magnus Sandström & Roger Abrahamsson [04-2004]     | dm, tdm, sd, re, bel, hq         | A    | *Version before fix*            |
