/*  rPAMext Version: v21
    ...
    Changes onto kvcodPAM v211: _timeout.gsc

  - v21 adds logprints
  - v25 reactivates timeouts
  - v25 added xy for an hudelement?
  - v211 added restoreLastSpawnpoint for after timeouts
  - EXv21 outcommented v25, added debug cvar, marked changes
...
//v211 added this
	...
	if (getcvar("rpam_debug_p") == "1") { iprintln("_timeout::Start_Timeout_Mode set game['restoreLastSpawnpoint'] = true"); }
	logprint("_timeout::Start_Timeout_Mode set game['restoreLastSpawnpoint'] = true\n");
