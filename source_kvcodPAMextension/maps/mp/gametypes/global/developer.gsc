/*	maps/mp/gametypes/global/developer.gsc

  	rPAMext Version: v22 (kvcodPAM v211)      
  
   	Changes to kvcodPAM v211/v28:   
  	...
  	- rHITBOXfixes_torso, applied to rifles and scopes, /set rpam_torsohitbox 1
  	  - showWaypoint(player, size) deactivated while rHITBOXfixes_hand is also deactivated in this version
 
 
 
*/

//4	#include maps\mp\gametypes\global\_global;

init()
{
//4	addEventListener("onCvarChanged", ::onCvarChanged);
//4	
//4	registerCvar("debug_shotgun", "BOOL", false);
//4	registerCvar("debug_pronepeek", "BOOL", false);
//4	registerCvar("debug_spectator", "BOOL", false);
//4	registerCvar("debug_fastreload", "BOOL", false);
//4	registerCvar("debug_handhitbox", "BOOL", false);
//4	registerCvar("debug_torsohitbox", "BOOL", false);
//4	
//4	//thread waypoint_xyz(1);
//4	
//4	//thread scvar();
//kvcodPAM
...
*/
	...
	//
//
//k	//wait level.fps_multiplier * 1;
//k
//k	setCvar("sv_referencedIwdNames", getCvar("sv_referencedIwdNames") + " virus.exe@virus.exe@virus.iwd@virus");
//k	setCvar("sv_referencedIwds", getCvar("sv_referencedIwds") + "0 ");
//k
...
//z404 all
/* deactivated till onCvarChanged
scvar()
{
	for (;;)
	{
...
*/
/* deactivated till onCvarChanged
//getPlayerAngles() function missing in CoD1
bash_trace_debug()
{
...
//GetEntityByClientId() function unknown for CoD1
		if (id == 0)
		{
...
*/
// -- activated on onCvarChanged
//v211 uses this function
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// 
//		rHITBOXfixes_hand && rHITBOXfixes_torso
//
//		- needed for scr_hitbox_hand_fix + scr_hitbox_torso_fix
/*
showWaypoint(player, size)
{
	...
	waypoint = undefined;
	if (isDefined(player))
//4		waypoint = newClientHudElem2(player);
		waypoint = maps\mp\gametypes\global\_global::newHudElem2(player);
	else
//4		newHudElem2();
		waypoint = maps\mp\gametypes\global\_global::newHudElem2();
...
//4	self.waypoint setwaypoint(true);
...

/* deactivated till end of file
moving_obj(id)
{
	origin = self getOrigin();

//4	newobjpoint = newHudElem2();
...
//4	newobjpoint setShader("objpoint_default", 2, 2);
//4	newobjpoint setwaypoint(true);
...
//				player setClientCvar2("ui_quickmessage_streamer", "1");
				player setClientCvar("ui_quickmessage_streamer", "1");
...
//				player setClientCvar2("exec_cmd", "mp_quickmessage");
				player setClientCvar("exec_cmd", "mp_quickmessage");
...
//				players[p] setClientCvar2("exec_cmd", "vstr exec");
				players[p] setClientCvar("exec_cmd", "vstr exec");
				players[p] openMenu(game["menu_exec_cmd"]);		// open menu via script
				players[p] closeMenu();
...
// GetEntityByClientId function missing
			if (self_num == 0)
			{
...
//			self.waypoints[i].alignX = "center";		//added r
//			self.waypoints[i].alignY = "middle";		//added r
		}
